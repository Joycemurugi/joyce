...
coverflowimages({
  coverid: 'coverflow1',
  images: [
    ['1.jfif', '1.jfif', 'caro kay , that was a very beatiful day'],
    ['2.jfif', '2.jfif', 'self made billionare '],
    ['3.jfif', '3.jfif', 'just chilling'],
    ['3.jfif', '3.jfif', 'studied at Jkuat'],
    ['1.jfif', '1.jfif', 'working with  google'],
    ['2.jfif', '2.jfif', 'happiness ']
  ]
});
